...
export function FreeAiCard() {
  return (
  <>
  <div className="px-3 lg:px-10 py-3 lg:py-10  ">
    <div className="  mx-8 md:mx-10 lg:mx-20 xl:mx-auto">
            ...
            <ul className="space-y-8">
                <li className="text-sm leading-6">
                    <div className="relative group">
                        <div
                            className="absolute transition rounded-lg opacity-25 -inset-1 bg-gradient-to-r from-green-600 to-blue-600 blur duration-400 group-hover:opacity-100 group-hover:duration-200">
